...
/**
 * Created by Кирилл on 18.04.2016.
 */
public class WithoutParallelMerge implements Sorting {

    private final Random random = new Random();

    public WithoutParallelMerge() {
    }
    ...
    public int[] sort(int[] unsortedArray) {
        ...
        merge(unsortedArray, arrays);
        finishMerge(unsortedArray, arrays);

        return unsortedArray;
    }

    private void merge(int[] resultArray, List<int[]> arrays) {
    ...
    private void finishMerge(int[] resultArray, List<int[]> arrays) {
